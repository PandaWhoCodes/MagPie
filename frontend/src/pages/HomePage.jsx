...
// Lazy load framer-motion components only for Midnight Black theme
const AnimatedBackground = lazy(() => import('../components/themes/AnimatedBackground').then(module => ({ default: module.AnimatedBackground })));
